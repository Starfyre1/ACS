...
public class Sarn extends PriestsBase {
	...
	Second Requisite = Wisdom
		...
		Second Requisite-Dexterity/Wisdom
			...
			7)Starsight (-8)				7)Protection II (-8)f
			...
			5)Nightsight (-15)				5)Alertness III (-90)F
	...
	*/
	...
	public Sarn() {
		...
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						...
						new SpellRecord("Starsight", 0, 8, 0, TKStringHelpers.EMPTY_STRING), //$NON-NLS-1$
		...
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						...
						new SpellRecord("Nightsight", 0, 15, 0, TKStringHelpers.EMPTY_STRING)))); //$NON-NLS-1$
