...
public class Sithrian extends ElvesBase {
	...
	*/
	...
	private String[]	mInnateDisplayList	= { "Tracking", "Conceal", "Stealth", "Hear", "Detect Magic", "Detect Morals I", "Herbal Lore", "Star Sight", "Speak with Animals", "Spell Casting", "Resist Magical Sleep 40%" };	//$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ //$NON-NLS-9$ //$NON-NLS-10$ //$NON-NLS-11$
