...
public class Earth extends MagesBase {
	...
	/*
		...
		Second Requisite = Willpower
			...
			1)Control Cloud (-1)		1)Break Fall (-0)
	...
	*/
	...
	public Earth() {
		...
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						...
						new SpellRecord(1, "Build", 0, -1, 0), //$NON-NLS-1$
		...
		// Power Four:
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						new SpellRecord(4, "Build", 0, 15, 1), //$NON-NLS-1$
		...
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						...
						new SpellRecord(6, "Flesh to Stone", 0, 8, 0), //$NON-NLS-1$
						new SpellRecord(6, "Golem", 0, -1, 1)))); //$NON-NLS-1$

		// Power Seven :
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						new SpellRecord(7, "Escape", 0, 3, 0), //$NON-NLS-1$
						new SpellRecord(7, "Part Rock II", 3, 10, 0), //$NON-NLS-1$
						new SpellRecord(7, "Sink", 0, 1, 1)))); //$NON-NLS-1$
		//, new SpellRecord(7, "Part Rock III", 3, 10, 0)

		// Power Eight :
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						new SpellRecord(8, "Negate Gravity", 0, 8, 0)))); //$NON-NLS-1$
	}
