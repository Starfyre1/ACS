	...
	*/
	...
	public Thaer() {
		...
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						...
						new SpellRecord("Sleep I", 0, 3, 1, TKStringHelpers.EMPTY_STRING), //$NON-NLS-1$
		...
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						...
						new SpellRecord("Spears of Light I", 0, 3, 1, TKStringHelpers.EMPTY_STRING), //$NON-NLS-1$
		...
		// Power Four
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						new SpellRecord("Protection IV", 4, 25, 0, TKStringHelpers.EMPTY_STRING), //$NON-NLS-1$
