	...
	*/
	...
	public Illusion() {
		...
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						...
						new SpellRecord(0, "Dispel Illusion I", 1, 3, 0), //$NON-NLS-1$
						new SpellRecord(0, "Image I", 1, 3, 1), //$NON-NLS-1$
						new SpellRecord(0, "Pain I", 1, 3, 1), //$NON-NLS-1$
						...
						new SpellRecord(0, "Slight Odors", 0, 2, 1), //$NON-NLS-1$
						new SpellRecord(0, "Slight Tastes", 0, 2, 1), //$NON-NLS-1$
						new SpellRecord(0, "Substance I", 1, 4, 1)))); //$NON-NLS-1$

		// Power One:
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						new SpellRecord(1, "Area of Fear", 0, 3, 0), //$NON-NLS-1$
						new SpellRecord(1, "Area of Fog", 0, 4, 1), //$NON-NLS-1$
						new SpellRecord(1, "Complex Sounds", 0, 3, 1), //$NON-NLS-1$
						new SpellRecord(1, "Deafness", 0, 6, 0), //$NON-NLS-1$
						new SpellRecord(1, "Disguise", 0, 15, 0), //$NON-NLS-1$
						new SpellRecord(1, "Dispel Illusion II", 2, 4, 0), //$NON-NLS-1$
						new SpellRecord(1, "Hypnotic Image", 0, 3, 0), //$NON-NLS-1$
						new SpellRecord(1, "Image II", 2, 4, 1), //$NON-NLS-1$
						new SpellRecord(1, "Multiple Images", 0, 2, 1), //$NON-NLS-1$
						new SpellRecord(1, "Pain II", 2, 4, 1), //$NON-NLS-1$
						new SpellRecord(1, "Performance", 0, 2, 1), //$NON-NLS-1$
						new SpellRecord(1, "Strong Odors", 0, 3, 1), //$NON-NLS-1$
						new SpellRecord(1, "Strong Tastes", 0, 3, 1), //$NON-NLS-1$
						new SpellRecord(1, "Substance II", 2, 5, 1)))); //$NON-NLS-1$

		// Power Two:
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						new SpellRecord(2, "Blindness", 0, 8, 0), //$NON-NLS-1$
						new SpellRecord(2, "Dispel Illusion III", 3, 5, 0), //$NON-NLS-1$
						new SpellRecord(2, "Familiar", 0, 600, 0), //$NON-NLS-1$
						new SpellRecord(2, "Image III", 3, 5, 1), //$NON-NLS-1$
						new SpellRecord(2, "Image IV", 4, 5, 1), //$NON-NLS-1$
						new SpellRecord(2, "Invisibility I", 1, 15, 0), //$NON-NLS-1$
						new SpellRecord(2, "Pain III", 3, 5, 1), //$NON-NLS-1$
						new SpellRecord(2, "Pleasure", 0, 10, 1), //$NON-NLS-1$
						new SpellRecord(2, "Perpetual Dark", 0, 10, 0), //$NON-NLS-1$
						new SpellRecord(2, "Substance III", 3, 6, 1)))); //$NON-NLS-1$

		// Power Three:
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						new SpellRecord(3, "Anarchy I", 1, 5, 0), //$NON-NLS-1$
						new SpellRecord(3, "Dispel Illusion IV", 4, 6, 0), //$NON-NLS-1$
						new SpellRecord(3, "Image V", 5, 6, 1), //$NON-NLS-1$
						new SpellRecord(3, "Substance IV", 4, 7, 1), //$NON-NLS-1$
						new SpellRecord(3, "Pain IV", 4, 7, 1)))); //$NON-NLS-1$

		// Power Four:
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						new SpellRecord(4, "Anarchy II", 2, 10, 0), //$NON-NLS-1$
						new SpellRecord(4, "Dispel Illusion V", 5, 7, 0), //$NON-NLS-1$
						new SpellRecord(4, "Polymorph I", 1, 8, 0), //$NON-NLS-1$
						new SpellRecord(4, "Pain V", 5, 7, 1), //$NON-NLS-1$
						new SpellRecord(4, "Substance V", 5, 8, 1)))); //$NON-NLS-1$

		// Power Five:
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						new SpellRecord(5, "Dispel Illusion VI", 6, 8, 0), //$NON-NLS-1$
						new SpellRecord(5, "Pain VI", 6, 8, 1), //$NON-NLS-1$
						new SpellRecord(5, "Substance VI", 6, 9, 0), //$NON-NLS-1$
						new SpellRecord(5, "Summon Shadows", 0, 10, 0)))); //$NON-NLS-1$

		// Power Six:
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						new SpellRecord(6, "Dispel Illusion VII", 7, 9, 0), //$NON-NLS-1$
						new SpellRecord(6, "Duration", 0, 30, 1), //$NON-NLS-1$
						new SpellRecord(6, "Invisibility II", 2, 15, 0), //$NON-NLS-1$
						new SpellRecord(6, "Pain VII", 7, 9, 1), //$NON-NLS-1$
						new SpellRecord(6, "Polymorph II", 2, 10, 0), //$NON-NLS-1$
						new SpellRecord(6, "Substance VII", 7, 10, 1)))); //$NON-NLS-1$

		// Power Seven:
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						new SpellRecord(7, "Pain VIII", 8, 10, 1), //$NON-NLS-1$
						new SpellRecord(7, "Polymorph III", 3, 10, 0), //$NON-NLS-1$
						new SpellRecord(7, "Substance VIII", 8, 11, 1)))); //$NON-NLS-1$

		// Power Eight:
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						new SpellRecord(8, "Pain IX", 9, 11, 1), //$NON-NLS-1$
						new SpellRecord(8, "Permanent Illusion", 0, 60, 1), //$NON-NLS-1$
						new SpellRecord(8, "Substance IX", 9, 12, 1)))); //$NON-NLS-1$
