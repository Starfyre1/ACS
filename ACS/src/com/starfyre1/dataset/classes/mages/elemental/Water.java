	...
	*/
	...
	public Water() {
		...
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						...
						new SpellRecord(3, "Summon Water Beast I", 1, 3, 0)))); //$NON-NLS-1$

		// Power Four:
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						new SpellRecord(4, "Cold Spell III", 3, 6, 1), //$NON-NLS-1$
						new SpellRecord(4, "Lower Water", 0, 15, 0), //$NON-NLS-1$
						new SpellRecord(4, "Summon Water Beast II", 2, 5, 0), //$NON-NLS-1$
		...
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						...
						new SpellRecord(5, "Summon Water Beast III", 3, 8, 0)))); //$NON-NLS-1$

		// Power Six:
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						new SpellRecord(6, "Cold Spell V", 5, 8, 1), //$NON-NLS-1$
						new SpellRecord(6, "Summon Storm", 0, 30, 0), //$NON-NLS-1$
						new SpellRecord(6, "Summon Water Beast IV", 4, 10, 0), //$NON-NLS-1$
		...
		// Power Eight:
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						new SpellRecord(8, "Pressure", 0, 25, 0)))); //$NON-NLS-1$
