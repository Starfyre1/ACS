...
public class Orn extends PriestsBase {
	...
	*/
	...
	public Orn() {
		...
		// Power Four:
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						new SpellRecord(4, "Absorb III", 3, 25, 0), //$NON-NLS-1$
		...
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						...
						new SpellRecord(5, "Summon Water Beast III", 3, 9, 0), //$NON-NLS-1$
						new SpellRecord(5, "Tidal Wave", 0, 300, 0)))); //$NON-NLS-1$

		// Power Six:
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						new SpellRecord(6, "Absorb IV", 0, 30, 0), //$NON-NLS-1$
		...
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						...
						new SpellRecord(8, "Pressure", 0, 10, 0)))); //$NON-NLS-1$
