...
public class Chauntil extends PriestsBase {
	...
	Second Requisite = Wisdom
		...
		Second Requisite - Willpower
			...
			1)Speak w/Animals (-1)			1)Calm Waters (-20)F
			...
			3)Shell/Waterbreathing (-35)	3)Transformation (-500)
	...
	*/
	...
	public Chauntil() {
		...
		// Power Four:
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						new SpellRecord("Summon water Mon.. II", 2, 40, 0, TKStringHelpers.EMPTY_STRING), //$NON-NLS-1$
		...
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						...
						new SpellRecord("Sold Spell V", 5, 8, 1, TKStringHelpers.EMPTY_STRING), //$NON-NLS-1$
						new SpellRecord("Shell/Waterbreathing", 0, 35, 0, TKStringHelpers.EMPTY_STRING)))); //$NON-NLS-1$
