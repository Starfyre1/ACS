...
public class Ranger extends Warrior {
	...
	*/
	...
	// Knights of Athri (King's Rangers)
	//	private int		mMinimumStats[]			= new int[] { 12, 12, 11, 12, 12, 12, 10, 0, 10 };
	// Wilderness Rangers
	private int		mMinimumStats[]			= new int[] { 10, 10, 12, 11, 10, 12, 0, 0, 10 };
	...
	public int getStamina() {
		int stamina = super.getStamina();

		// DW Rangers get a 1D6 bonus to their stamina... this needs to be saved
		// stamina += 1D6;
