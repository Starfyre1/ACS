	...
	*/
	...
	public Lorrell() {
		...
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						...
						new SpellRecord("Detect Morals I", 0, 10, 0, TKStringHelpers.EMPTY_STRING), //$NON-NLS-1$
		...
		// Power Four:
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						new SpellRecord("Shield IV", 4, 40, 0, TKStringHelpers.EMPTY_STRING), //$NON-NLS-1$
		...
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						...
						new SpellRecord("Circle of Life", 0, 25, 0, TKStringHelpers.EMPTY_STRING), //$NON-NLS-1$
		...
		// Power Seven:
		mSpells.add(new ArrayList<SpellRecord>(Arrays.asList( //
						new SpellRecord("Regeneration", 0, 200, 0, TKStringHelpers.EMPTY_STRING), //$NON-NLS-1$
