...
public class MagicSpellTab extends DeterminationTab implements ActionListener {
	...
	private JPanel createCenterPanel() {
		...
		for (int i = 0; i < ROWS; i++) {
			mSchoolLabel[i] = TKComponentHelpers.createTextField(CharacterSheet.FIELD_SIZE_EXLARGE, TEXT_FIELD_HEIGHT, this);
			schoolPanel.add(mSchoolLabel[i]);

			mSpellLabel[i] = TKComponentHelpers.createTextField(CharacterSheet.FIELD_SIZE_EXLARGE, TEXT_FIELD_HEIGHT, this);
